...
function exercise1(num1) {
  ...
  // consider other data types beside strings and variables.
    //since we consider only string and number, when we give a variable that's type of boolean, it will not pass. 
    // also false and 0 is equal but according to my code it will return false. 
  ...
  function exercise8(amount1, amount2, minimum, maximum) {
    ...
    if((amount1<maximum && amount1>minimum) && (amount2>minimum && amount2 < maximum)){
        answer8 = true
    }
    else{
        answer8 = false
  ...
  // Please answer in a comment below.
    //I found it easy. I needed to check the syntax of switch condition.
